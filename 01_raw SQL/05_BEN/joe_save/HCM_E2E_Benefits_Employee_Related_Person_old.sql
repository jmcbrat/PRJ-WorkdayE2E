...
insert into #Empl_Related_Person
--Dependent
...
,ISNULL(hr_family.ZIP_CODE, '99999') as 'PostalCode_Home' --koaHills: CNP559
...
,'' as 'AddressLine_2-Home'
,CASE WHEN hr_emerinfo.CITY IS NULL OR trim(hr_emerinfo.CITY) = '' THEN 'Not Available' ELSE trim(hr_emerinfo.CITY) END  as 'City_Home' --koaHills: CNP561
,'' as 'CitySubdivision-Home'
,'' as 'CitySubdivision2-Home'
,IIF(hr_emerinfo.state is not null,'USA-'+hr_emerinfo.state,'') as 'Region-Home'
,'' as 'RegionSubdivision-Home'
,'' as 'RegionSubdivision2-Home'
,ISNULL(hr_emerinfo.zip, '99999') as 'PostalCode-Home' --koaHills: CNP559
